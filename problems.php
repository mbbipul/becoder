...
<main>
    <div class="container-fluid mt-4">
		...
		<div class="d-flex  col-example">Simple Input:</div>
		<div class="d-flex  col-example"></div>
		<div class="d-flex  col-example">Simple Output:</div>
		<div class=""></div>
		      </div>
		  </div>
		</div>
